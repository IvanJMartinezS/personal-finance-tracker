export const ES = {
  ...
  expenses:{
    ...
    invalidCategory: 'La categoría seleccionada no existe. Por favor, elige una categoría válida.',
  ...
  incomes:{
    ...
    createSuccess: 'Ingreso registrado',
    createError: 'Error al registrar el ingreso',
    invalidCategory: 'La categoría seleccionada no existe. Por favor, elige una categoría válida.',
    filterMonth: 'Mes',
    filterCategory: 'Categoria',
  },
  ...
  accounts: {
    ...
    registerBalanceSuccess: 'Saldo registrado',
    registerBalanceError: 'Error al registrar el saldo',
    amount: 'Saldo',
    notes: 'Notas',
